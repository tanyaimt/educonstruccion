<tr><td colspan="4"><center><h2>Obras</h2></center><td></tr>
		...
		<tr>
			<td colspan="4">
				<input type="submit" class="button" value="Registrar Obra" name="btnAdministrarProyectoLogistica" >
				<input type="submit" class="button" value="Actualizar Obra" name="btnAdministrarProyectoLogistica" >
				<input type="submit" class="button" value="Eliminar Obra" name="btnAdministrarProyectoLogistica" >
			</td>
		</tr>