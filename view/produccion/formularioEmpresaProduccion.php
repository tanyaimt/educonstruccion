		...
		<tr>
			<td colspan="2">
				<input type="text" name="idEmpresaCliente" placeholder="ID Empresa" value="<?php echo $idEmpresaCliente;?>">
				<input type="hidden" name="tipoEmpresa" " value="Cliente">
			</td>
			<td colspan="2" align="right">
				<input type="submit" class="button" value="Buscar Empresa" name="btnAdministrarProyectoProduccion" >
				<input type="submit" class="button" value="Buscar Todas Las E" name="btnAdministrarProyectoProduccion" >
		...
		<tr>
			<td colspan="2">
				<input type="text" name="razonSocial" placeholder="Razon Social" size="49" value="<?php echo $razonSocial;?>">
			</td>
			<td>
		...
		<tr>
			...
			<td colspan="2">
				<input type="text" name="calleEmpresa" placeholder="Calle" value="<?php echo $calleEmpresa;?>" size="45">
			</td>
			<td>
		...
		<tr>
			<td colspan="4">
				<input type="submit" class="button" value="Limpiar" name="btnAdministrarProyectoProduccion" >
		...
		<tr>
			<td colspan="4">
				<center>
					<input type="submit" class="button" value="Confirmar" name="btnAdministrarProyectoProduccion">
				</center>
			</td>
		</tr>
