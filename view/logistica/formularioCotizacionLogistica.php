		...
		<tr>
			<td colspan="4">
				<input type="submit" class="button" value="Registrar Cotizacion" name="btnAdministrarProyectoLogistica" >
				<input type="submit" class="button" value="Actualizar Cotizacion" name="btnAdministrarProyectoLogistica" >
				<input type="submit" class="button" value="Eliminar Cotizacion" name="btnAdministrarProyectoLogistica" >
